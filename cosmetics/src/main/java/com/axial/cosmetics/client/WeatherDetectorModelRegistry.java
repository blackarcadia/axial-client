...
public final class WeatherDetectorModelRegistry {
    private static final Identifier MODEL_ID = Identifier.of("minecraft", "block/custom/weatherdetector");
    private static final net.minecraft.block.BlockState TARGET_STATE = Blocks.NOTE_BLOCK.getDefaultState()
